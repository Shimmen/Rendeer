...
public:
	GBuffer(int renderWidth, int renderHeight)
		: FrameBuffer(false)
		, albedo(renderWidth, renderHeight, GL_RGB, GL_CLAMP_TO_BORDER, GL_LINEAR, GL_LINEAR)
		, normal(renderWidth, renderHeight, GL_RGB, GL_CLAMP_TO_BORDER, GL_NEAREST, GL_NEAREST)
		, depth(renderWidth, renderHeight, GL_DEPTH_COMPONENT, GL_CLAMP_TO_EDGE, GL_NEAREST, GL_NEAREST)
	{
